...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vapeur sèche à 132°C, coffret 9 accessoires, zéro chimie. $74.99 tout inclus, livraison Canada & USA en 5 à 8 jours." },
      ...
      { property: "og:description", content: "Vapeur sèche à 132°C, coffret 9 accessoires, zéro chimie. $74.99 tout inclus, livraison Canada & USA en 5 à 8 jours." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "VaporPro — Nettoyeur Vapeur Haute Pression" },
      { name: "twitter:description", content: "Vapeur sèche à 132°C, coffret 9 accessoires, zéro chimie. $74.99 tout inclus, livraison Canada & USA en 5 à 8 jours." },
