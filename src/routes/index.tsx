...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Vapeur sèche à 132°C, coffret 9 accessoires, sans produits chimiques. $74.99 tout inclus, livraison Canada & USA en 5 à 8 jours via nos fournisseurs partenaires." },
      { property: "og:title", content: "VaporPro — Nettoyeur Vapeur Haute Pression" },
      { property: "og:description", content: "Dégraisse et assainit à 132°C, zéro chimie. $74.99 livraison incluse au Canada & USA en 5-8 jours." },
    ],
  }),
  component: Index,
});
